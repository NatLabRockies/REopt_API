# Generated by Django 4.2.26 on 2026-04-16 15:21
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddField(
            ...
            field=models.BooleanField(blank=True, default=True, help_text='Boolean indicator if CHP follows the electrical load by running at capacity or meeting the load only', null=True),
        ),
        migrations.AddField(
            model_name='chpinputs',
            name='include_cooling_in_chp_size',
            field=models.BooleanField(blank=True, default=True, help_text='Boolean indicator if cooling load (via absorption chiller) is included in the heuristic CHP sizing calculation along with heating loads', null=True),
        ),
        migrations.AddField(
            model_name='chpinputs',
        ...
        migrations.AddField(
            ...
            field=models.BooleanField(blank=True, default=True, help_text='Boolean indicator if CHP produced heat either serves absorption chiller or sends it to waste', null=True),
        ),
        migrations.AddField(
